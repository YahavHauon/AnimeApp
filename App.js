...
const DrawerNavigator = (mainScreen) => {
  return <Drawer.Navigator initialRouteName={mainScreen} drawerContent={props => {
    ...
    <Drawer.Screen name={screensNames.topList} component={TabNavigator} options={{ title: screens.mainTitle }} />
    <Drawer.Screen name={screensNames.AboutUs} component={AboutUs} options={{ title: screens.aboutUs }} />
  </Drawer.Navigator>
}
        ...
        <RootSiblingParent>
          <NavigationContainer>
            <Stack.Navigator screenOptions={{
              ...
              <Stack.Screen name={screensNames.HomePage} component={DrawerNavigator} options={{
                headerShown: false
              }} />
              <Stack.Screen name={screensNames.AnimeDetail} component={AnimeDetail} options={({ route, navigation }) => {
                return {
                  title: route.params.anime.title,
                  headerRight: () => (<IconButton icon="share-outline" size={22} color="white" onPress={() => {
